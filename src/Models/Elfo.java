...
public class Elfo extends Personaje {
    public Elfo(String nombre, String apodo, /*String fechaNacimiento, Integer edad,*/ Double salud, Integer velocidad, Integer destreza, Integer fuerza, Integer nivel, Double armadura) {
    ...
    public Double calcularAtaque(Double velocidadDefensor, Double armaduraDefensor) {
        ...
        return ((((valorAtaque*efectividadDisparo)-poderDefensa)/500)*100)*1.05;
    }
